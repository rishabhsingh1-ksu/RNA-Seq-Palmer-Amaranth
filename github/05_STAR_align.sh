...
#
# Usage: sbatch 05_STAR_align.sh <genome_index_dir> <read1.fastq.gz> <read2.fastq.gz> <output_prefix>
#
# Arguments:
...
# Project: RNA-Seq analysis of herbicide resistance in Amaranthus palmeri
#===============================================================================
